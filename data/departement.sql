...
CREATE TABLE IF NOT EXISTS departement (
  departement_id bigint generated by default as identity not null,
  departement_code varchar DEFAULT NULL,
  departement_nom varchar DEFAULT NULL,
  departement_nom_uppercase varchar DEFAULT NULL,
  departement_slug varchar DEFAULT NULL,
  departement_nom_soundex varchar DEFAULT NULL,
